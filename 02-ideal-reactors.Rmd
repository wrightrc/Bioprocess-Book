...
```{answer, include=params$key}
>*In this case the design equation simplifies to $k_1\left[C_{A0}(1-x_A)\right]^2 = \frac{dx_A}{dt}$. *
>$$\int_0^tk_1C_{A0}^2dt = \int_0^{x_A}\frac{dx_A}{(1-x_A)^2}$$
