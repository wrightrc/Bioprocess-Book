...
So for the reaction above we can make a table for each chemical species and element: 
 ...
 $\nu_i A_i$ |$\require{mhchem}\ce{Cl2}$ |  $\require{mhchem}\ce{C3H6}$  |  $\require{mhchem}\ce{NaOH}$ | $\require{mhchem}\ce{C3H6O}$ | $\require{mhchem}\ce{NaCl}$  | $\require{mhchem}\ce{H2O}$ | $\sum_{i}$
----:|:----:|:----:|:----:|:----:|:----:|:----:|:----:
